...
namespace MashBoxSDK.MapTools
{
    public sealed partial class MGTerrainWorldEditor
    {
        ...
        void DrawWorldDataEstimator(MGTerrainWorld world)
        {
            ...
            EditorGUILayout.LabelField("Detail Texture Buffers", EstimateBytes(m_EstimateGpuPerTile * total));
            ...
            {
                EditorGUILayout.LabelField("Total Mesh + Texture Buffers", "≈ " + EstimateBytes((mesh + m_EstimateGpuPerTile) * total), EditorStyles.boldLabel);
                EditorGUILayout.LabelField("Sum of detail texture buffers and surface mesh buffers. Excludes CPU copies, other assets and engine overhead.", EditorStyles.wordWrappedMiniLabel);
