...
namespace MashBoxSDK.MapTools
{
    internal static class MGTerrainStampMapSetup
    {
        ...
        static Texture2D CreateBlank(string tileName, int width, int height, bool normal)
        {
            ...
            try
            {
                ...
                string path = AssetDatabase.GenerateUniqueAssetPath("Assets/MG Terrain Stamp Maps/"
                    + MGTerrainAppearanceCaptureAssets.TerrainPrefix(tileName)
                    + (normal ? "BlankNormalWS.asset" : "BlankRGB.asset"));
