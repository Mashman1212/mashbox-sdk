...
{
    public class MGLitBasicShaderGUI : LightingShaderGraphGUI
    {
        private static Texture2D cover;
        public MGLitBasicShaderGUI()
        {
        ...
        protected override void OnMaterialGUI(MaterialEditor materialEditor, MaterialProperty[] props)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    ShaderEnforcer.EnforceLitBasicShader(mat);
        ...
        private static void DrawBanner()
        {
            if (cover == null)
            {
                cover = AssetDatabase.LoadAssetAtPath<Texture2D>("Packages/com.mg.mashbox.sdk/Editor/Shaders/MGLitBasicShader_Banner.png");

                if (cover == null)
                {
                    cover = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/MashBoxSDK/Editor/Shaders/MGLitBasicShader_Banner.png");
                }
            }
